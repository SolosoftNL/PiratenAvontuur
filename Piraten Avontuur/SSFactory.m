...
-(NSArray *)tiles{
    ...
    tile1.imgBackground = [UIImage imageNamed:@"test.jpg"];
    ...
    tile2.imgBackground = [UIImage imageNamed:@"test.jpg"];
    ...
    tile3.imgBackground = [UIImage imageNamed:@"test.jpg"];
    ...
    tile4.imgBackground = [UIImage imageNamed:@"test.jpg"];
    ...
    tile5.imgBackground = [UIImage imageNamed:@"test.jpg"];
    ...
    tile6.imgBackground = [UIImage imageNamed:@"test.jpg"];
    ...
    tile7.strStory=@"You have sighted a pireate battle off the coast. Should we intervene?";
    tile7.imgBackground = [UIImage imageNamed:@"test.jpg"];
    ...
    tile8.imgBackground = [UIImage imageNamed:@"test.jpg"];
    ...
    tile9.imgBackground = [UIImage imageNamed:@"test.jpg"];
    ...
    tile10.imgBackground = [UIImage imageNamed:@"test.jpg"];
    ...
    tile11.imgBackground = [UIImage imageNamed:@"test.jpg"];
    ...
    tile12.imgBackground = [UIImage imageNamed:@"test.jpg"];
